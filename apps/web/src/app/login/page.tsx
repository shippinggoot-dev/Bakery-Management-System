    ...
    <div className="min-h-[70vh] flex items-center justify-center">
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="text-brand-400 mt-2 text-sm">Sign in to your account</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-rose-100 shadow-sm p-8 space-y-5">
          ...
          {sent ? (
            <div className="text-center space-y-2 py-2">
              ...
              <p className="font-semibold text-brand-700">Check your inbox</p>
              <p className="text-sm text-brand-400">
                We sent a sign-in link to <strong className="text-brand-600">{email}</strong>.
            ...
            <form onSubmit={handleMagicLink} className="space-y-3">
              ...
              <p className="text-xs text-brand-300 text-center">
                A one-time sign-in link will be sent to your inbox.
              </p>
            </form>
          )}
          ...
          {error && (
            <p className="text-sm text-red-500 bg-red-50 border border-red-200 rounded-xl px-3 py-2">
              {error.includes("401") || error.includes("access token")
                ? "Invalid access token — check your Shopify token."
                : error}
            </p>
          )}
        </div>
